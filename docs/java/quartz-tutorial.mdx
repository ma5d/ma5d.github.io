...
<GiteeFileContent owner="ma5d" repo="SringQuartz" filePath="src/main/java/org/ma5d/springquartz/pom.xml" branch="main" startLine="33" endLine="36"/>
...
<GiteeFileContent owner="ma5d" repo="SringQuartz" filePath="src/main/java/org/ma5d/springquartz/job/MyJob.java" branch="main"/>
...
<GiteeFileContent owner="ma5d" repo="SringQuartz" filePath="src/main/java/org/ma5d/springquartz/config/QuartzConfig.java" branch="main"/>
